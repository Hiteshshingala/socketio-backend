...
module.exports.SELECT_GROUP = `Select a group to chat.`;
...
/* Group relate */
module.exports.GROUPNAME_NOT_FOUND = `groupName can't be empty.`;
module.exports.GROUP_REGISTRATION_FAILED = `Group registration unsuccessful.`;
module.exports.GROUP_REGISTRATION_OK = `User registration successful.`;
module.exports.GROUPID_NOT_FOUND = `Group Id can't be empty.`;
module.exports.GROUP_UPDATION_FAILED = `Group updation unsuccessful.`;
module.exports.GROUP_UPDATION_OK = `User updation successful.`;
